...
$sql = "INSERT INTO company (id, name, lat, lon, description, url, image, category)
        ...
        (NULL ,'SIS · Swedish Standards Institute','59.346345','18.0299142','ISO TC 67 WG10 PT1 committee by SIS to develop the first international accepted standard for LNG bunkering','http://www.sis.se/','http://www.sis.se/ClientUI/Images/cssimg/logo.png','Research'),
