...
$sql = "INSERT INTO company (id, name, lat, lon, description, url, image, category)
        ...
        (NULL ,'GDF Suez',NULL,NULL,'Biggest utility in the world and is one of the leading LNG playes in the world and main LNG  importer in Europé. Involved in North Stream project to transport Russian LNG to Europé. NORDSTREAM = 9% owner','http://www.gdfsuez.com/en/group/governance/operational-organization/global-gas-lng/','','Shipping'),
        ...
        (NULL ,'SIS · Swedish Standards Institute','59.32893','18.06491','ISO TC 67 WG10 PT1 committee by SIS to develop the first international accepted standard for LNG bunkering','http://www.sis.se/','http://www.sis.se/ClientUI/Images/cssimg/logo.png','Research'),
        (NULL ,'CIMET \(Centre for International Maritime Education and Training\)',
        '56.854041',
        '14.833023',
        ...
        (NULL ,'Mann-Teknik AB','58.713521','13.828542','A coupling manufacturer Mann Tek is a coupling manufacturer. Mann Tek produces and markets products for safe and environmentally friendly handling of aggressive fluids for the chemical and petrochemical industries.','http://www.mann-tek.com/','http://www.mann-tek.com/sites/all/themes/manntek/layout/Mann-Tek-logo.png','End-user technologies'),
