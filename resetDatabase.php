...
$sql = "INSERT INTO company (name, lat, lon, decription, url, image, category)
        ...
        ('CIMET \(Centre for International Maritime Education and Training\)',
        '56.854041',
        '14.833023',
        'This project will establish an international, STCW compliant, Centre for International Maritime Education and Training \(CIMET\) involving six partner institutions in the EU and Canada. Multilateral cooperation in the development of curricula and student exchanges in this highly focused area of vocational education will generate considerable added value for each participating institution as they develop their courses and programmes to comply with STCW requirements as set down by the International Maritime Organisation \(IMO\). The development of computer and web-based course materials will also be an important output of this collaboration.',
        'http://lnu.se/schools/kalmar-maritime-academy/research/previous-projects/cimet?l=en',
        'http://lnu.se/img/logo_symbol.png',
        'Training'),
        ...
        ('CRYO AB','57.566028','11.247246','CRYO AB's productline includes a large variety of LNG equipment, both onshore and offshore. The company’s LNG programme includes complete LNG receiving terminals, semi-trailer for land transport, fuel tanks for ships and ferries, as well as gas supply back-up systems and mobile equipment for the testing of gas turbines.','http://www.cryo.se/','','Shipbuilding & Repair'),
        ...
        ('Mann-Teknik AB','58.713521','13.828542','A coupling manufacturer Mann Tek is a coupling manufacturer. Mann Tek produces and markets products for safe and environmentally friendly handling of aggressive fluids for the chemical and petrochemical industries.','http://www.mann-tek.com/','http://www.mann-tek.com/sites/all/themes/manntek/layout/Mann-Tek-logo.png','End-user technologies'),
